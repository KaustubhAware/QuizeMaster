...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['username'], $_POST['password'])) {
    ...
    $password = $_POST['password'];  $fullname = $_POST['fullname'];  $email = $_POST['email'];

    // Perform user registration (insert user into the database)
...
<body>
  ...
  <div class="back-shapes">
    ...
    <form class="form" method="post" action="">
       <p class="form-title">Join Quiz Master</p>
        ...
        <div class="input-container">
          <input placeholder="Enter your name" pattern=".{8,}" type="text" name="fullname" id="fullname" required>
          <span>
            <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"></path>
            </svg>
      ...
      <div class="input-container">
          <input placeholder="Enter password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" type="password" placeholder="Password" name="password" id="password" required>
